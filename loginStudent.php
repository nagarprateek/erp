...
$host = "localhost";
$user = "root";
$password1 = "Mysql@31106";
$db = "unvdb";

$link = mysqli_connect($host,$user,$password1,$db,3307);
...
<div class="uk-margin">
    <div class="uk-inline">
        ...
        <input class="uk-input inputlog" placeholder="Email ID" type="email" name="email" value="" required>
    </div>
</div>
...
<div class="uk-margin">
    <div class="uk-inline">
        ...
        <input class="uk-input inputlog" placeholder="Password" type="password" name="password" value="" required>
    </div>
</div>
<div class="uk-margin">
    <div class="uk-inline">
